# -*- coding: utf-8 -*-
"""
Created on Fri May  8 13:02:39 2020
...
#%%
#%% PERIOD B
os.chdir("C:/Users/Marta Via/Documents/1. PhD/A. BCN_Series/ACSM_PalauReial_2017_09/MVIA/ACSM_new/2nd SoFi Results/3rd SoFi Results/Statistics")
f =  pd.read_csv("Factors_1718.txt", skip_blank_lines=False,sep="\t", keep_default_na=True)
#%%
#%%
au17=f['OA AUTUMN 2017'].tolist()
wi=f['OA WINTER'].tolist()
sp=f['OA SPRING'].tolist()
su=f['OA SUMMER'].tolist()
au18=f['OA AUTUMN 2018'].tolist()

#
OA_K=stats.kruskal(au17,wi,sp,su,au18,nan_policy='omit')
#%%
# -*- coding: utf-8 -*-
"""
...
#%%
y =  pd.read_csv("Factors_1718_Period.txt", skip_blank_lines=False,sep="\t",parse_dates=True, 
                 infer_datetime_format=True, keep_default_na=True)


#%%
mk_test(y['HOA'],0.05)
#%%
HOA=mk_test(y['HOA'],0.05)
COA=mk_test(y['COA'],0.05)
BBOA=mk_test(y['BBOA'],0.05)
LOOA=mk_test(y['LOOA'],0.05)
MOOA=mk_test(y['MOOA'],0.05)
OA=mk_test(y['OA'],0.05)
